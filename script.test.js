...
test("check that fn is converting to sha-256", () => {
    return hashPassword().then(hashed => {
        expect(tempPassTwo).toEqual('0da0aa0d60e506004e08e0170bd09f01008d0910e206a0fe0620810da0c80fd0a00090100400a70a60d70bd09b0430b5')
    })
